...
<nav class="sticky navbar">
	...
	<div class="nav">
		<ul class="nav__items">
			<li class="nav_item p-4"><a href="#home" class="nav_link">Home</a></li>
			<li class="nav_item p-4"><a href="#about" class="nav_link">About</a></li>
			<!-- <li class="nav_item"><a href="#portfolio" class="nav_link">Portfolio</a></li> -->
			<li class="nav_item p-4"><a href="#contact" class="nav_link">Contact</a></li>
		</ul>
	</div>
</nav>
...
.nav_item:nth-child(1) .nav_link::before {
	content: '1. ';
}

.nav_item:nth-child(2) .nav_link::before {
	content: '2. ';
}

.nav_item:nth-child(3) .nav_link::before {
	content: '3. ';
}

.nav_item:nth-child(4) .nav_link::before {
	content: '4. ';
}
...
@media screen and (max-width: 799px) {
	...
	.nav .nav_items .nav_item:nth-child(1) a {
		transition-delay: 0.2s;
	}

	.nav .nav_items .nav_item:nth-child(2) a {
		transition-delay: 0.3s;
	}

	.nav .nav_items .nav_item:nth-child(3) a {
		transition-delay: 0.4s;
	}

	.nav .nav_items .nav_item:nth-child(4) a {
		transition-delay: 0.5s;
	}

	.nav .nav_items .nav_item:not(:first-child) {
		margin-left: 0;
	}

	.nav .nav_items .navitem .nav_link {
		padding: 10px 25px;
		opacity: 0;
		color: var(--shades);
		font-size: 24px;
	...
	.nav .nav_items .navitem .nav_link:hover {
		color: var(--secondary);
	}
